...
<form name="form1" method="post">
    ...
    <input type="hidden"  name="command" />
								...
								$sql=mysqli_query($conn, "SELECT * FROM products WHERE category='$_GET[sub_cat]' ORDER BY date DESC");
                            ...
                            <div class="charts_container">
                                <div class="chart_container">
                                     <div class="alert alert-info">Sorry the product you are looking for is not Listed, . Thank You for using With LJstores</div>  
             ...
             <?php } else{ 
						...
						<div class="product-image-wrapper">
								...
								<div class="single-products">
										...
										<i class="fa fa-shopping-cart"></i>View Product</a></div>
