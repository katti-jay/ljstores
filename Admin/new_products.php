...
?>
	...
	<div class="breadcrumbs">
				<ol class="breadcrumb">
				  ...
				  <li class=""><a href="products.php">Active Product</a></li>
				  <li class="active"><a href="new_products.php">New/Pending Product</a></li>
	...
	<?php include('includes/category.php')?>
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items">
						...
						<h2 class="title text-center">New/Pending Product</h2>
						
			<?php 
							 
								$sql=mysql_query("SELECT * FROM products WHERE product_status = 0 ORDER BY date DESC");
