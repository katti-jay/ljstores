...
?>
	...
	<div class="breadcrumbs">
				<ol class="breadcrumb">
				  ...
				  <li><a href="products.php">Active Product</a></li>
				  <li><a href="new_products.php">New/Pending Product</a></li>
				  <li class="active" ><a href="banned_products.php">Banned Product</a></li>
				</ol>
			</div>
	<?php include('includes/category.php')?>
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items">
						...
						<h2 class="title text-center">Banned Product</h2>
						
			<?php 
							 
								$sql=mysqli_query("SELECT * FROM products WHERE product_status = 2 ORDER BY date DESC");
