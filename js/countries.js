/*
	*	Original script by: Wandam Matthew
	*	spurgowdy@gmail.com
...
s_a[84]="Ashanti Region|Brong-Ahafo Region|Central Region|Eastern Region|Greater Accra|Northern Region|Upper East Region|Upper West Region|Volta Region|Western Region";
s_a[85]="Gibraltar";
...
function print_state(state_id, state_index){
	...
	option_str.length=0;	 
	option_str.options[0] = new Option('Select State/Region','');
	option_str.selectedIndex = 0;
